...
#Diffuse
        ...
        diffuse_alhpa = eh.get_scalar("DiffuseAlpha")
        if diffuse_alhpa is not None:
            mulNode.inputs[0].default_value = diffuse_alhpa.scalar
        else:
        ...
        normal_texture_tex = eh.get_texture("NormalAlphaTex", True)
        if normal_texture_tex is not None:
            nAImgNode = CreateShaderNodeTexImage(CurMat, normal_texture_tex, -1200, -500, "NormalAlphaTex")
